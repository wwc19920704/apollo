...
apollo_config_db_url=jdbc:mysql://192.168.31.52:3306/apolloconfigdb?characterEncoding=utf8
apollo_config_db_username=root
apollo_config_db_password=Root123..

# apollo portal db info
apollo_portal_db_url=jdbc:mysql://192.168.31.52:3306/apolloportaldb?characterEncoding=utf8
apollo_portal_db_username=root
apollo_portal_db_password=Root123..

# meta server url, different environments should have different meta server addresses
dev_meta=http://192.168.190.129:8080
#fat_meta=http://someIp:8080
#uat_meta=http://anotherIp:8080
pro_meta=http://192.168.190.128:8080
